...
function Modal(props) {
  ...
  return (
    <StyledModal isOpen={isOpen} style={ModalStyling}>
      <Container>
        <section>
          ...
          <p>
            RGO-Alangilan. ("we," "our," or "us") is committed to protecting
            your privacy. This Privacy Policy explains how your personal
            information is collected, used, and disclosed by RGO-Alangilan. This
            Privacy Policy applies to our website, www.batstateu-tenants.com,
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Country: where RGO-Alangilan or the owners/founders of
              RGO-Alangilan are based, in this case is Philippines.
            </li>
            <li>
              Customer: refers to the company, organization or person that signs
              up to use the RGO-Alangilan Service to manage the relationships
            ...
            <li>
              ...
              RGO-Alangilan and use the services.
            </li>
            ...
            <li>
              ...
              RGO-Alangilan or are under contract to perform a service on behalf
            ...
            <li>
              Service: refers to the service provided by RGO-Alangilan as
            ...
            <li>
              Website: RGO-Alangilan's site, which can be accessed via this URL:
              www.batstateu-tenants.com.
            </li>

            <li>
              You: a person or entity that is registered with RGO-Alangilan to
              use the Services.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            in this Policy.By submitting your email address on this website, you
            agree to receive emails from us. You can cancel your participation
            in any of these email lists at any time by clicking on the opt-out
            link or other unsubscribe option that is included in the respective
        ...
        <section>
          ...
          <p>
            We are incorporated in the Philippines. Information collected via
        ...
        <section>
          ...
          <p>
            ...
            on our systems (subject to the following paragraph), by canceling
        ...
        <section>
          ...
          <br />
          <p>Welcome to batstateu-tenants!</p>
          <br />
          <p>
            These terms and conditions outline the rules and regulations for the
            use of RGO-Alangilan's Website, located at
            www.batstateu-tenants.com.
          </p>
          <br />
          <p>
        ...
        <section>
          ...
          <br />
          <ul className="indented">
            <li>Republish material from batstateu-tenants</li>
            <li>Sell, rent or sub-license material from batstateu-tenants</li>
            <li>
              Reproduce, duplicate or copy material from batstateu-tenants
            </li>
            <li>Redistribute content from batstateu-tenants</li>
          </ul>
          <br />
          <p>
          ...
          <p>
            ...
            RGO-Alangilan does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of RGO-Alangilan,its agents and/or affiliates.
            ...
            RGO-Alangilan shall not be liable for the Comments or for any
          ...
          <br />
          <p>
            RGO-Alangilan reserves the right to monitor all Comments and to
        ...
        <section>
          ...
          <p>
            ...
            RGO-Alangilan; and (d) the link is in the context of general
          ...
          <p>
            inform us by sending an e-mail to RGO-Alangilan. Please include your
        ...
        <section>
          ...
          <ul className="indented">
            <li>
              imit or exclude our or your liability for death or personal
              injury;
            </li>
            <li>
